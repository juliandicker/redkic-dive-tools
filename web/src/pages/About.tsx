              ...
              <div className="card-body">
                ...
                <div className="d-flex gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '0.85rem', marginBottom: 0 }}>
                      ...
                      density above the limit at that depth. Most planning tools don't surface density
                ...
                <div className="d-flex gap-3">
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '0.85rem', marginBottom: 0 }}>
                      The profile chart shows the Bühlmann ceiling rising as tissue saturation builds —
                      the dashed line is the ceiling, and when it catches your depth, a stop is required.
                      Below the chart, all 16 compartments are shown as individual saturation bars, coloured
                      by how close each is to its M-value. These visualisations are essentially absent from
                      commercial planning tools. They're here to make the algorithm transparent: useful for
                      instructors explaining deco to students, and for any diver who wants to understand
                      <em> why</em> the schedule looks the way it does.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="card mb-4">
              <div className="card-body">
                ...
                <p style={{ fontSize: '0.85rem', marginBottom: '1.25rem' }}>
                  ...
                  deeper. GF High sets the allowed saturation at the last stop before surfacing. 35/75 is a
                  common starting point for technical CCR work. CCR mode has separate gradient factors for
                  the bailout ascent because a bailout from depth is a different risk profile to a planned
                  OC dive.
                </p>
                ...
                <p style={{ fontSize: '0.85rem', marginBottom: '1.25rem' }}>
                  Each bar represents one of the 16 Bühlmann compartments, ordered from fastest
                  half-time (left) to slowest (right). The colour shows saturation relative to that
                  compartment's M-value: green is well clear, the bar reaches the limit line at the deco
                  ceiling. Clicking a point on the profile chart snaps the tissue display to that moment.
                  This is the clearest way to see which compartments are driving your decompression —
                  fast tissues drive the deep stops, slow tissues drive the shallow ones.
                </p>
